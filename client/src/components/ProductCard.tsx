    ...
    <Card className="group overflow-hidden shadow-card hover:shadow-card-hover transition-smooth">
      ...
      >
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-2">
          <Badge variant="secondary" className="bg-black backdrop-blur flex align-center justify-center pb-1">
            {category}
          </Badge>
          {stock < 10 && stock > 0 && (
        ...
        {/* Wishlist Button */}
        <div className="absolute top-3 left-3 opacity-0 group-hover:opacity-100 transition-smooth">
      ...
      <CardContent className="p-4">
        <h3
          className="font-semibold text-lg mb-2 line-clamp-2 group-hover:text-primary transition-smooth cursor-pointer"
          onClick={() => navigate(`/product/${id}`)}
        >
          {name}
        </h3>
